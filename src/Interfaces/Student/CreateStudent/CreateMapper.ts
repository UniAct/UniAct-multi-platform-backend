...
type CreateStudentRaw = Awaited<ReturnType<typeof StudentRepository.CreateStudent>>;

export function MapCreateStudent(raw: CreateStudentRaw) {
  return {
...
export type CreateStudentResponseDto = ReturnType<typeof MapCreateStudent>;