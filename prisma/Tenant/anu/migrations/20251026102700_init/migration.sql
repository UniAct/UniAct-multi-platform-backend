...
-- CreateEnum
CREATE TYPE "ClassroomType" AS ENUM ('Lecture', 'Lab', 'Auditorium', 'Other');
...
-- CreateIndex
CREATE INDEX "Fee_program_level_id_idx" ON "Fee"("program_level_id");

-- CreateIndex
CREATE INDEX "Fee_semester_id_idx" ON "Fee"("semester_id");
...
-- CreateIndex
CREATE INDEX "AcademicLoadSemester_program_id_idx" ON "AcademicLoadSemester"("program_id");

-- CreateIndex
CREATE INDEX "AcademicLoadSemester_semester_id_idx" ON "AcademicLoadSemester"("semester_id");

-- CreateIndex
CREATE UNIQUE INDEX "AcademicLoadSemester_program_id_semester_id_program_level_i_key" ON "AcademicLoadSemester"("program_id", "semester_id", "program_level_id");
...
-- CreateIndex
CREATE INDEX "Classroom_is_available_idx" ON "Classroom"("is_available");

-- CreateIndex
CREATE UNIQUE INDEX "Classroom_room_number_building_key" ON "Classroom"("room_number", "building");

-- CreateIndex
CREATE INDEX "Room_created_by_idx" ON "Room"("created_by");

-- CreateIndex
CREATE INDEX "Room_access_code_idx" ON "Room"("access_code");

-- CreateIndex
CREATE INDEX "ClassSession_course_id_idx" ON "ClassSession"("course_id");

-- CreateIndex
CREATE INDEX "ClassSession_teacher_id_idx" ON "ClassSession"("teacher_id");

-- CreateIndex
CREATE INDEX "ClassSession_program_id_idx" ON "ClassSession"("program_id");

-- CreateIndex
CREATE INDEX "ClassSession_semester_id_idx" ON "ClassSession"("semester_id");

-- CreateIndex
CREATE INDEX "ClassSession_day_of_week_start_time_idx" ON "ClassSession"("day_of_week", "start_time");

-- CreateIndex
CREATE INDEX "CourseAssessment_class_session_id_idx" ON "CourseAssessment"("class_session_id");
...
-- CreateIndex
CREATE INDEX "CourseRegistration_session_id_idx" ON "CourseRegistration"("session_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "CourseRegistration_student_id_session_id_semester_id_key" ON "CourseRegistration"("student_id", "session_id", "semester_id");
...
-- CreateIndex
CREATE INDEX "AttendanceSession_class_session_id_idx" ON "AttendanceSession"("class_session_id");

-- CreateIndex
CREATE INDEX "AttendanceSession_session_date_idx" ON "AttendanceSession"("session_date");

-- CreateIndex
CREATE INDEX "AttendanceSession_faculty_member_id_idx" ON "AttendanceSession"("faculty_member_id");

-- CreateIndex
CREATE INDEX "AttendanceSession_is_active_idx" ON "AttendanceSession"("is_active");
...
-- CreateIndex
CREATE INDEX "RoomPost_room_id_idx" ON "RoomPost"("room_id");

-- CreateIndex
CREATE INDEX "RoomPost_author_id_idx" ON "RoomPost"("author_id");

-- CreateIndex
CREATE INDEX "RoomPost_created_at_idx" ON "RoomPost"("created_at");

-- CreateIndex
CREATE INDEX "RoomPost_is_pinned_room_id_idx" ON "RoomPost"("is_pinned", "room_id");

-- CreateIndex
CREATE INDEX "RoomPostAttachment_post_id_idx" ON "RoomPostAttachment"("post_id");

-- CreateIndex
CREATE INDEX "RoomPostComment_post_id_idx" ON "RoomPostComment"("post_id");

-- CreateIndex
CREATE INDEX "RoomPostComment_author_id_idx" ON "RoomPostComment"("author_id");

-- CreateIndex
CREATE INDEX "RoomPostComment_created_at_idx" ON "RoomPostComment"("created_at");
...
-- AddForeignKey
ALTER TABLE "Fee" ADD CONSTRAINT "Fee_semester_id_fkey" FOREIGN KEY ("semester_id") REFERENCES "Semester"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AcademicLoadSemester" ADD CONSTRAINT "AcademicLoadSemester_semester_id_fkey" FOREIGN KEY ("semester_id") REFERENCES "Semester"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ClassSession" ADD CONSTRAINT "ClassSession_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "Course"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClassSession" ADD CONSTRAINT "ClassSession_teacher_id_fkey" FOREIGN KEY ("teacher_id") REFERENCES "Staff"("user_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClassSession" ADD CONSTRAINT "ClassSession_program_id_fkey" FOREIGN KEY ("program_id") REFERENCES "Program"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClassSession" ADD CONSTRAINT "ClassSession_classroom_id_fkey" FOREIGN KEY ("classroom_id") REFERENCES "Classroom"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClassSession" ADD CONSTRAINT "ClassSession_semester_id_fkey" FOREIGN KEY ("semester_id") REFERENCES "Semester"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CourseAssessment" ADD CONSTRAINT "CourseAssessment_class_session_id_fkey" FOREIGN KEY ("class_session_id") REFERENCES "ClassSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProgramCourse" ADD CONSTRAINT "ProgramCourse_program_id_fkey" FOREIGN KEY ("program_id") REFERENCES "Program"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CourseRegistration" ADD CONSTRAINT "CourseRegistration_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "ClassSession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AttendanceSession" ADD CONSTRAINT "AttendanceSession_class_session_id_fkey" FOREIGN KEY ("class_session_id") REFERENCES "ClassSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RoomPost" ADD CONSTRAINT "RoomPost_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES "Room"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoomPost" ADD CONSTRAINT "RoomPost_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoomPostAttachment" ADD CONSTRAINT "RoomPostAttachment_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "RoomPost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoomPostComment" ADD CONSTRAINT "RoomPostComment_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "RoomPost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoomPostComment" ADD CONSTRAINT "RoomPostComment_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
